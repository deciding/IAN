...
import time
import pickle
#awk 'FNR==NR {arr[FNR]=$0; next} FNR%3==1{context=$0} FNR%3==2{aspect=$0} FNR%3==0{sent=$0} FNR%3==0 && arr[FNR/3]!=sent{print context; print aspect; print sent; print arr[FNR/3]}' predict2/test_demo.txt data/restaurant/test.txt > predict2/wrong_ans.txt
